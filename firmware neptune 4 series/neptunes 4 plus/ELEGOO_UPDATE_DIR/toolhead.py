...
class ToolHead:
    ...
    def cmd_SET_VELOCITY_LIMIT(self, gcmd):
                ...
                if config.has_option("speed_mode", "print_mode"):
                    ...
                    if print_mode == 0:
                        ...
                        if config.has_option("speed_mode", "max_accel_normal"):
                            max_accel_normal = config.getfloat("speed_mode", "max_accel_normal")
                        if config.has_option("speed_mode", "max_accel_to_decel_normal"):
                            max_accel_to_decel_normal = config.getfloat("speed_mode", "max_accel_to_decel_normal")
                        ...
                        if config.has_option("speed_mode", "max_accel_silent"):
                            max_accel_silent = config.getfloat("speed_mode", "max_accel_silent")
                        if config.has_option("speed_mode", "max_accel_to_decel_silent"):
                            max_accel_to_decel_silent = config.getfloat("speed_mode", "max_accel_to_decel_silent")
                        ...
                        if config.has_option("speed_mode", "max_accel_berserk"):
                            max_accel_berserk = config.getfloat("speed_mode", "max_accel_berserk")
                        if config.has_option("speed_mode", "max_accel_to_decel_berserk"):
                            max_accel_to_decel_berserk = config.getfloat("speed_mode", "max_accel_to_decel_berserk")
        ...
        if max_velocity is not None:
            if get_conf_max_velocity_success:
                if max_velocity > conf_max_velocity:
                    max_velocity = conf_max_velocity
            self.max_velocity = max_velocity
        if max_accel is not None:
            if get_conf_max_accel_success:
                if max_accel > conf_max_accel:
                    max_accel = conf_max_accel
            self.max_accel = max_accel
        if square_corner_velocity is not None:
            self.square_corner_velocity = square_corner_velocity
        if requested_accel_to_decel is not None:
            if get_conf_max_accel_to_decel_success:
                if requested_accel_to_decel > conf_max_accel_to_decel:
                    requested_accel_to_decel = conf_max_accel_to_decel
    ...
    def cmd_M204(self, gcmd):
        ...
        if accel is None:
            ...
            accel = min(p, t)
        if get_conf_max_accel_success:
            if accel > conf_max_accel:
                accel = conf_max_accel
